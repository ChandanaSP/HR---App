...
#Quarter Day
		if not self.fraction_of_daily_salary_for_quarter_day:
			self.fraction_of_daily_salary_for_quarter_day = 0.25
#Three Quarter Day
		if not self.fraction_of_daily_salary_for_three_quarter_day:
			self.fraction_of_daily_salary_for_three_quarter_day = 0.75
#One Quarter Day
		if not self.fraction_of_daily_salary_for_one_quarter_day:
			self.fraction_of_daily_salary_for_one_quarter_day =0.25
#One Half Day
		if not self.fraction_of_daily_salary_for_one_half_day:
			self.fraction_of_daily_salary_for_one_half_day = 1.5
